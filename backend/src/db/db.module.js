...
var csv_record_entity_1 = require("../model/csv-record.entity");
            ...
            imports: [
                typeorm_1.TypeOrmModule.forRootAsync({
                    ...
                    useFactory: function (config) { return ({
                        ...
                        entities: [csv_record_entity_1.CsvRecord],
                        synchronize: true, // disable in production
                    }); },
                }),
                typeorm_1.TypeOrmModule.forFeature([csv_record_entity_1.CsvRecord]),
            ],
