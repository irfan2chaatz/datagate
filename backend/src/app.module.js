...
var csv_controller_1 = require("./controller/csv.controller");
var AppModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [config_module_1.ConfigModule, db_module_1.DbModule],
            controllers: [app_controller_1.AppController, csv_controller_1.CsvController],
            providers: [app_service_1.AppService, csv_service_1.CsvService, logger_service_1.LoggerService],
        })];
