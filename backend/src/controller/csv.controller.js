...
var CsvController = function () {
    var _classDecorators = [(0, common_1.Controller)('csv')];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _instanceExtraInitializers = [];
    var _uploadFile_decorators;
    var CsvController = _classThis = /** @class */ (function () {
        function CsvController_1(csvService) {
            this.csvService = (__runInitializers(this, _instanceExtraInitializers), csvService);
        }
        CsvController_1.prototype.uploadFile = function (file) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.csvService.processCsv(file)];
                });
            });
        };
        return CsvController_1;
    }());
    __setFunctionName(_classThis, "CsvController");
    (function () {
        ...
        CsvController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return CsvController = _classThis;
}();
